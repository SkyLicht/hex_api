...
from core.data.schemas.planner.planner_schema import WorkPlanSchema
...
class WorkPlanRepository:
    ...
    def get_work_plan_by_str_date_and_line_name(self, str_date:str, line_name:str) -> WorkPlanSchema | None:
        orm = self.work_plan_dao.get_work_plan_by_str_date_and_line_name(str_date, line_name)
        if orm is None:
